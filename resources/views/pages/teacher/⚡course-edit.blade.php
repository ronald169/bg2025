...
class extends Component {
    ...
    public function fillForm(): void
    {
        ...
        $this->subject_id = $this->course->subject_id;
        $this->level = $this->course->level;
        $this->estimated_duration = $this->course->estimated_duration;
        $this->price = $this->course->price;
        $this->sale_price = $this->course->sale_price;
        $this->is_published = $this->course->is_published;
        $this->is_featured = $this->course->is_featured ?? false;
        $this->requirements = $this->course->requirements ?? [];
        $this->what_you_will_learn = $this->course->what_you_will_learn ?? [];
        $this->tags = $this->course->tags ?? [];
        $this->meta_title = $this->course->meta_title ?? '';
        $this->meta_description = $this->course->meta_description ?? '';
        $this->meta_keywords = $this->course->meta_keywords ?? '';
    }
    ...
    public function update(): void
    {
        ...
        $this->success(__('Course updated successfully! 🎉'));
        $this->redirectRoute('teacher.courses');
    }
...
<div class="py-4 md:py-6">
    <div class="max-w-5xl px-3 mx-auto md:px-4">
        ...
        <div class="flex flex-col gap-3 mb-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
                <h1 class="text-xl font-bold md:text-2xl">✏️ {{ __('Edit Course') }}</h1>
                <p class="mt-1 text-sm text-base-content/70">{{ __('Modify course details') }}</p>
            </div>
        </div>
