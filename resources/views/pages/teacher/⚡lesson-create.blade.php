...
class extends Component {
    ...
    public float $duration_minutes = 10; // Saisie en minutes
    public int $order = 0;
    ...
    public function save(): void
    {
        ...
        $this->success(__('Lesson created successfully! 🎉'));
...
<div class="py-4 md:py-6">
    <div class="max-w-5xl px-3 mx-auto md:px-4">
        ...
        {{-- Header --}}
        <div class="mb-6">
            <h1 class="text-xl font-bold md:text-2xl">➕ {{ __('Create New Lesson') }}</h1>
        ...
        <x-form wire:submit="save" class="space-y-5">
            <x-card class="shadow-sm">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        {{-- <x-markdown wire:model="content" rows="10" placeholder="{{ __('HTML content – you can add images, tables, formatting') }}" /> --}}
            ...
            <x-slot:actions>
                <div class="flex justify-end gap-3">
                    ...
                    <x-button label="{{ __('Create Lesson') }}" class="btn-primary" type="submit" spinner="save" />
                </div>
            </x-slot:actions>
        </x-form>
    </div>
